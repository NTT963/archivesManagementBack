...
public class POIPptToHtml {
	...
	public static boolean pptToHtml(String sourcePath, String targetDir) {
		...
		if (pptFile.exists()) {
			try {
				...
				if (PPT.equals(type)) {
					String htmlStr = "<!DOCTYPE html><html><head><meta charset=\"UTF-8\"></head><body><div style=\"width: 100%;text-align: center;margin-top: 70px\">"
								+toImage2003(sourcePath, targetDir,pptFileName).replaceAll("[a-zA-Z]:", "")
								+"</div></body>";
					FileUtils.writeFile(htmlStr, targetDir + "/"+pptFileName+".html");
					return true;
				} else if (PPTX.equals(type)) {
					String htmlStr = "<!DOCTYPE html><html><head><meta charset=\"UTF-8\"></head><body><div style=\"width: 100%;text-align: center;margin-top: 70px\">"
							+toImage2007(sourcePath, targetDir, pptFileName).replaceAll("[a-zA-Z]:", "")
							+"</div></body>";
					FileUtils.writeFile(htmlStr, targetDir + "/"+pptFileName+".html");
					return true;
				} else {
